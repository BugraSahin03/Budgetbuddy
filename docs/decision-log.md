...
- Die Import-Vorschau speichert die geladene Datei serverseitig ueber einen kurzlebigen Preview-Token, damit `Import bestaetigen` nach `Vorschau laden` ohne erneute Dateiauswahl funktioniert.
